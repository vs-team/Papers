...
\begin{mathpar}
	...
	{\langle \text{if \textit{c} then \textit{T} else \textit{E} ; \textit{k}} \rangle \Rightarrow \langle \text{\textit{T} ; \textit{k}} \rangle}
\end{mathpar}
...
\begin{mathpar}
	...
	{\langle \text{if \textit{c} then \textit{T} else \textit{E} ; \textit{k}} \rangle \Rightarrow \langle \text{\textit{E} ; \textit{k}} \rangle}
\end{mathpar}
...
Template metaprogramming complexity can grow exponentially, for example when we want to get the values of the list elements, to the point that a simple function as \texttt{nth} requires six templates.
