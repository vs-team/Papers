...
\vspace{0.5cm}
\noindent
\textbf{Problem statement: } \textit{To what extent does the use of a meta-compiler ease the development of a domain-specific language and what is the performance trade-off?}
