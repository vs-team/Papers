...
\begin{algorithm}
	...
	\begin{algorithmic}
		\Function {buildDeclarationType} {$A \text{ list of arguments returned by the parser}$}
			\If {$A = \emptyset$}
				\State \Return $Empty$
