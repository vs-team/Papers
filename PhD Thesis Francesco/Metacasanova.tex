\documentclass[9pt,b5paper,openright]{extbook}
...
\newcommand{\rqContentTwo}{How much is the performance loss introduced by the meta-compiler with respect to an implementation written in a language typically used in game development and is this loss acceptable in this context?}
